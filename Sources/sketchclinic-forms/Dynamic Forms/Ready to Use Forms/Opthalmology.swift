...
extension FormContainer {
    static var opthalmology: FormContainer {
        let subjectiveStep = FormStepContainer(title: "History") {
            LongTextFormItem(title: "Subjective", placeholder: "Subjective")
            ...
            LongTextFormItem(title: "Objective", placeholder: "Objective")
        }

        let rightEye = FormStepContainer(title: "Exam Right Eye") {

            // from 6 to 60 (step 1, trailing to leading)
            NumberFormItem(title: "Visual Acuity ( 6 /)", minValue: 6, maxValue: 60, step: 1, format: .integer)
            NumberFormItem(title: "Pin Hole (6 / )", minValue: 6, maxValue: 60, step: 1, format: .integer)

            TextFormItem(title: "Glasses", placeholder: "Glasses")
            TextFormItem(title: "Refraction", placeholder: "Refraction")

            // from 0 to 71
            NumberFormItem(title: "IOP (mmhg)", minValue: 0, maxValue: 71, step: 1, format: .integer)
